...
import 'package:xlo_app_flutter/helpers/extensions.dart';
import 'package:xlo_app_flutter/models/user.dart';
import 'package:xlo_app_flutter/repositories/user_repository.dart';
...
abstract class _SignupStore with Store {
  ...
  @computed
  bool get passValid => pass1 != null && pass1.length >= 6;
  String get pass1Error{
    if(pass1 == null || passValid)
      return null;
  ...
  bool get isFormValid => nameValid && emailValid
      && phoneValid && passValid && pass2Valid;
